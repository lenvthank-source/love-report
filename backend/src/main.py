...
def main():
    ...
    default_config_path = os.path.abspath(
        os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "sample", "input.json")
    )
    parser.add_argument(
        "-c", "--config",
        type=str,
        default=default_config_path,
        help=f"Path to the JSON configuration input file (default: {default_config_path})"
    )
