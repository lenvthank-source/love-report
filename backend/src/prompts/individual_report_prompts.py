...
# Length: 80-100 words per page (strict print-size ceiling)
# ──────────────────────────────────────────────────────────────
...
4. **Formatting Constraints**:
   - Write exactly 80 to 100 words. Be extremely concise.
...
Target word count: ~80-100 words (maximum 120 words).
""",
...
2. Write a MAXIMUM of 80 to 100 words total. Do not exceed this limit.
